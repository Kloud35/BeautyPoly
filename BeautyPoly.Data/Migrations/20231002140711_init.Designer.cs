...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeautyPoly.Models.Brand", b =>
                {
            ...
            modelBuilder.Entity("BeautyPoly.Models.BrandDetails", b =>
                {
                    b.Property<int>("BrandDetailsID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BrandDetailsID"), 1L, 1);
            ...
            modelBuilder.Entity("BeautyPoly.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("BeautyPoly.Models.ProductImages", b =>
                {
                    ...
                    b.Property<string>("ProductImagesCode")
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("BeautyPoly.Models.SaleItemBrand", b =>
                {
                    b.Property<int>("SaleItemBrandID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SaleItemBrandID"), 1L, 1);
                    ...
                    b.HasKey("SaleItemBrandID");

                    b.HasIndex("BrandID");

                    b.HasIndex("SaleID");

                    b.ToTable("SaleItemBrands");
                });

            modelBuilder.Entity("BeautyPoly.Models.SaleItemCategory", b =>
                {
                    b.Property<int>("SaleItemCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SaleItemCategoryID"), 1L, 1);
                    ...
                    b.HasKey("SaleItemCategoryID");

                    b.HasIndex("CateID");

                    b.HasIndex("SaleID");

                    b.ToTable("SaleItemCategories");
                });

            modelBuilder.Entity("BeautyPoly.Models.SaleItemProduct", b =>
                {
                    b.Property<int>("SaleItemProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SaleItemProductID"), 1L, 1);
                    ...
                    b.HasKey("SaleItemProductID");

                    b.HasIndex("ProductID");

                    b.HasIndex("SaleID");

                    b.ToTable("SaleItemProducts");
                });
            ...
            modelBuilder.Entity("BeautyPoly.Models.BrandDetails", b =>
                {
                    b.HasOne("BeautyPoly.Models.Brand", "Brand")
            ...
            modelBuilder.Entity("BeautyPoly.Models.CartDetails", b =>
                {
                    ...
                    b.HasOne("BeautyPoly.Models.ProductDetails", "ProductDetails")
                        .WithMany("CartDetails")
            ...
            modelBuilder.Entity("BeautyPoly.Models.Category", b =>
                {
                    b.HasOne("BeautyPoly.Models.Category", "Categorys")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("BeautyPoly.Models.LocationCustomer", b =>
                {
                    b.HasOne("BeautyPoly.Models.PotentialCustomer", null)
            ...
            modelBuilder.Entity("BeautyPoly.Models.Product", b =>
                {
                    b.HasOne("BeautyPoly.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("BeautyPoly.Models.ProductDetails", b =>
                {
                    ...
                    b.HasOne("BeautyPoly.Models.Product", null)
                        .WithMany("ProductDetails")
                        .HasForeignKey("ProductID");
            ...
            modelBuilder.Entity("BeautyPoly.Models.Category", b =>
                {
                    ...
                    b.Navigation("SaleItemCategories");
                });
